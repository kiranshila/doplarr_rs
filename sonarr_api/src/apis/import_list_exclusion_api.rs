...
pub async fn api_v3_importlistexclusion_bulk_delete(
    configuration: &configuration::Configuration,
    import_list_exclusion_bulk_resource: Option<models::ImportListExclusionBulkResource>,
) -> Result<(), Error<ApiV3ImportlistexclusionBulkDeleteError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ApiV3ImportlistexclusionBulkDeleteError> =
...
#[deprecated]
pub async fn api_v3_importlistexclusion_get(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::ImportListExclusionResource>, Error<ApiV3ImportlistexclusionGetError>> {
...
pub async fn api_v3_importlistexclusion_id_delete(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<(), Error<ApiV3ImportlistexclusionIdDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV3ImportlistexclusionIdDeleteError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn api_v3_importlistexclusion_id_get(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<models::ImportListExclusionResource, Error<ApiV3ImportlistexclusionIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV3ImportlistexclusionIdGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn api_v3_importlistexclusion_id_put(
    configuration: &configuration::Configuration,
    id: &str,
    import_list_exclusion_resource: Option<models::ImportListExclusionResource>,
) -> Result<models::ImportListExclusionResource, Error<ApiV3ImportlistexclusionIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV3ImportlistexclusionIdPutError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn api_v3_importlistexclusion_paged_get(
    configuration: &configuration::Configuration,
    page: Option<i32>,
    ...
    Error<ApiV3ImportlistexclusionPagedGetError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV3ImportlistexclusionPagedGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn api_v3_importlistexclusion_post(
    configuration: &configuration::Configuration,
    import_list_exclusion_resource: Option<models::ImportListExclusionResource>,
) -> Result<models::ImportListExclusionResource, Error<ApiV3ImportlistexclusionPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_import_list_exclusion_resource = import_list_exclusion_resource;
