...
pub async fn api_v3_queue_bulk_delete(
...
) -> Result<(), Error<ApiV3QueueBulkDeleteError>> {
...
pub async fn api_v3_queue_get(
    configuration: &configuration::Configuration,
    page: Option<i32>,
    page_size: Option<i32>,
    sort_key: Option<&str>,
    sort_direction: Option<models::SortDirection>,
    include_unknown_series_items: Option<bool>,
    ...
    status: Option<Vec<models::QueueStatus>>,
) -> Result<models::QueueResourcePagingResource, Error<ApiV3QueueGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn api_v3_queue_id_delete(
    configuration: &configuration::Configuration,
    id: i32,
    remove_from_client: Option<bool>,
    blocklist: Option<bool>,
    skip_redownload: Option<bool>,
    change_category: Option<bool>,
) -> Result<(), Error<ApiV3QueueIdDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_query_remove_from_client = remove_from_client;
    let p_query_blocklist = blocklist;
