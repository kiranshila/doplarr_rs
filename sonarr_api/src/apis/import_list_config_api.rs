...
pub async fn api_v3_config_importlist_get(
    configuration: &configuration::Configuration,
) -> Result<models::ImportListConfigResource, Error<ApiV3ConfigImportlistGetError>> {
...
pub async fn api_v3_config_importlist_id_get(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<models::ImportListConfigResource, Error<ApiV3ConfigImportlistIdGetError>> {
...
pub async fn api_v3_config_importlist_id_put(
    configuration: &configuration::Configuration,
    id: &str,
    import_list_config_resource: Option<models::ImportListConfigResource>,
) -> Result<models::ImportListConfigResource, Error<ApiV3ConfigImportlistIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
