...
pub async fn api_v3_delayprofile_get(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::DelayProfileResource>, Error<ApiV3DelayprofileGetError>> {
...
pub async fn api_v3_delayprofile_id_delete(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<(), Error<ApiV3DelayprofileIdDeleteError>> {
...
pub async fn api_v3_delayprofile_id_get(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<models::DelayProfileResource, Error<ApiV3DelayprofileIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn api_v3_delayprofile_id_put(
    configuration: &configuration::Configuration,
    id: &str,
    delay_profile_resource: Option<models::DelayProfileResource>,
) -> Result<models::DelayProfileResource, Error<ApiV3DelayprofileIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn api_v3_delayprofile_post(
    configuration: &configuration::Configuration,
    delay_profile_resource: Option<models::DelayProfileResource>,
) -> Result<models::DelayProfileResource, Error<ApiV3DelayprofilePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_delay_profile_resource = delay_profile_resource;
...
pub async fn api_v3_delayprofile_reorder_id_put(
    configuration: &configuration::Configuration,
    id: i32,
    after: Option<i32>,
) -> Result<Vec<models::DelayProfileResource>, Error<ApiV3DelayprofileReorderIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV3DelayprofileReorderIdPutError> =
