...
pub async fn api_v3_history_failed_id_post(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<(), Error<ApiV3HistoryFailedIdPostError>> {
...
pub async fn api_v3_history_get(
    configuration: &configuration::Configuration,
    page: Option<i32>,
...
) -> Result<models::HistoryResourcePagingResource, Error<ApiV3HistoryGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_languages {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
                    .map(|p| ("languages".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => req_builder.query(&[(
                "languages",
...
pub async fn api_v3_history_series_get(
    configuration: &configuration::Configuration,
    series_id: Option<i32>,
    season_number: Option<i32>,
    event_type: Option<models::EpisodeHistoryEventType>,
    include_series: Option<bool>,
    include_episode: Option<bool>,
) -> Result<Vec<models::HistoryResource>, Error<ApiV3HistorySeriesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn api_v3_history_since_get(
    configuration: &configuration::Configuration,
    date: Option<String>,
    event_type: Option<models::EpisodeHistoryEventType>,
    include_series: Option<bool>,
    include_episode: Option<bool>,
) -> Result<Vec<models::HistoryResource>, Error<ApiV3HistorySinceGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
