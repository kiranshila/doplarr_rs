...
pub async fn api_v3_series_editor_delete(
    configuration: &configuration::Configuration,
    series_editor_resource: Option<models::SeriesEditorResource>,
) -> Result<(), Error<ApiV3SeriesEditorDeleteError>> {
...
pub async fn api_v3_series_editor_put(
    configuration: &configuration::Configuration,
    series_editor_resource: Option<models::SeriesEditorResource>,
) -> Result<(), Error<ApiV3SeriesEditorPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_series_editor_resource = series_editor_resource;
