...
pub async fn api_v3_config_naming_examples_get(
    ...
    custom_colon_replacement_format: Option<&str>,
    multi_episode_style: Option<i32>,
    standard_episode_format: Option<&str>,
    daily_episode_format: Option<&str>,
    anime_episode_format: Option<&str>,
    series_folder_format: Option<&str>,
    season_folder_format: Option<&str>,
    specials_folder_format: Option<&str>,
    id: Option<i32>,
    ...
    if let Some(ref param_value) = p_query_custom_colon_replacement_format {
        req_builder =
            req_builder.query(&[("customColonReplacementFormat", &param_value.to_string())]);
    }
