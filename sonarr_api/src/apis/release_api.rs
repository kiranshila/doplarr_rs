...
pub async fn api_v3_release_get(
    configuration: &configuration::Configuration,
    series_id: Option<i32>,
    episode_id: Option<i32>,
    season_number: Option<i32>,
) -> Result<Vec<models::ReleaseResource>, Error<ApiV3ReleaseGetError>> {
...
pub async fn api_v3_release_post(
    configuration: &configuration::Configuration,
    release_resource: Option<models::ReleaseResource>,
) -> Result<(), Error<ApiV3ReleasePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
