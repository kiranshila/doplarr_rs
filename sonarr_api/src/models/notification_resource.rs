...
pub struct NotificationResource {
    ...
    #[serde(
        rename = "onEpisodeFileDelete",
        skip_serializing_if = "Option::is_none"
    )]
    pub on_episode_file_delete: Option<bool>,
    #[serde(
        rename = "onEpisodeFileDeleteForUpgrade",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "supportsOnImportComplete",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "supportsOnSeriesAdd",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_series_add: Option<bool>,
    #[serde(
        rename = "supportsOnSeriesDelete",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_series_delete: Option<bool>,
    #[serde(
        rename = "supportsOnEpisodeFileDelete",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_episode_file_delete: Option<bool>,
    #[serde(
        rename = "supportsOnEpisodeFileDeleteForUpgrade",
        skip_serializing_if = "Option::is_none"
    )]
