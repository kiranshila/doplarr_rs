...
pub async fn api_v3_manualimport_get(
    configuration: &configuration::Configuration,
    folder: Option<&str>,
    download_id: Option<&str>,
    movie_id: Option<i32>,
    filter_existing_files: Option<bool>,
) -> Result<Vec<models::ManualImportResource>, Error<ApiV3ManualimportGetError>> {
...
pub async fn api_v3_manualimport_post(
    configuration: &configuration::Configuration,
    manual_import_reprocess_resource: Option<Vec<models::ManualImportReprocessResource>>,
) -> Result<(), Error<ApiV3ManualimportPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
